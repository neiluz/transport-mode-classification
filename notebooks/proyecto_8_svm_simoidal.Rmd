...
2.  **Manejo del Desbalanceo de Clases:**
    ...
    -   En **R**, aunque se utilizó **SMOTE** y se ajustaron **pesos manuales** para balancear las clases, el proceso no fue tan automático como en Python. En **R**, el ajuste manual de los **pesos de clase** o el uso de **SMOTE** requiere intervención explícita, y los resultados mostraron que el modelo podría no haber aprovechado completamente estas técnicas, lo que resultó en un rendimiento inferior en los datos de prueba.
