...
1.  <div>
    ...
    >
    > 3.  **Chequear en eliminar colinealidad antes de modelar**
    >
    > 4.  **Probar modelo con las variables mas importante del RF**
    >
    > 5.  **Probar con difrentes kernel**
    >
    > 6.  **Cheaquear ROC para el overfitting, se presume por los resultados tan sesgados**
    >
    > 7.  **Evaluar aplicar Crossval**
    >
    > 8.  **SEGUIR ITERANDO**
